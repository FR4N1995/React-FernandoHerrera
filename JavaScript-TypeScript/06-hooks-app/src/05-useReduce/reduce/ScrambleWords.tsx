...
export const ScrambleWords = () => {
  ...
  const handleSkip = () => {
    ...
    //     return;
    // }
    // const uploadWords = words.splice(1);

    // setSkipCounter(skipCounter + 1);
    // setWords(uploadWords);
    // setCurrentWord(uploadWords[0]);
    // setScrambledWord(scrambleWord(uploadWords[0]));
    // setGuess('');
  ...
  const handlePlayAgain = () => {
    ...
    // const array = shuffleArray(GAME_WORDS);
    // setPoints(0);
    // setErrorCounter(0);
    // setGuess('');
    // setWords(array);
    ...
    // setIsGameOver(false);
    // setSkipCounter(0);
    // setScrambledWord(scrambleWord(array[0]));
    dispatch({ type: 'SATART_NEW_GAME', payload: getInitialState() })
