...
import { getTaskInitialState, taskReducer } from './reduce/tasksreducer';


/* ya no es necesario por que lo tenemos en el redeuce */
// interface Todo {
//   id: number;
//   text: string;
//   completed: boolean;
...
export const TasksApp = () => {
    ...
    //   dispach es para generar un nuevo state es muy similar al set del useState
    /* con la linea de anajo comentamos el useState */
  ...
  const addTodo = () => {
    ...
    // no es necesaria ya con el reduce
    ...
    // setTodos([...todos, setNewTodo]);

    /* esto se hace si contamos con un useReduce */
  ...
  const toggleTodo = (id: number) => {
    ...
    /* no es necesario con un useReduce */
  ...
  const deleteTodo = (id: number) => {
    ...
    /* esto se ocupa si no tenemos un use reduce y lo queremos hacer con use state */
